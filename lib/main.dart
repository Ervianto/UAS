...
import 'package:buku_tamu/models/model.dart';
...
class MainPage extends State<MainActivity> {
  ...
  */
  ...
  //           eventDef.eventName = "Perkuliahan";
  //           eventDef.eventAddress = "POLINEMA";
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  "Silakan memilih acara yang tersedia, atau tap pada tombol tambah di bawah untuk membuat acara baru",
